  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{I predominantly, utilized Pandas for data manipluation, DVC for data versioning, SKlearn, Pytorch and AutoML(fast prototyping) for modeling, MLFlow for MLOps, FastAPI for inference via web services, Docker for deployment, git for code version control, and many more that has been used as was needed. Fun fact: I would have gone mad without Tmux!}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
%-------------------------------------------
