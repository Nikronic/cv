...
\section{Technical Skills}
  \begin{tabular}{>{\raggedright}p{5cm} @{\hskip 1cm} p{10cm}}
    Deeply Involved: & Python, PyTorch, Tensorflow, Git, Windows, MLFlow, DVC, ExplainableAI \\[0.6cm]
    Have Experience With: & Linux/Debian, WSL2, Docker, Slurm, CI/CD, PostgreSQL, FastAPI, HTML, CSS \\[0.6cm]
