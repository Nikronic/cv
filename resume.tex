...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Full-time Artificial Intelligence Specialist}{Karaj, Iran}
       {Applications of Data Science and Machine Learning in Digital Marketing
       }
      ...
      \resumeItemListStart
        ...
        \resumeItem{Designed and implemented a full pipeline of automated data extraction, transformation, and preprocessing dealing with low/unlabeled data regime.}
        ...
        \resumeItem{Collaborated with employees, software engineers, and managers to revamp the data architecture and ensure data-driven decision making for increased coverage and quality of services.}
        \resumeItem{Utilized Python, PyTorch, SKlearn, Pandas, Snorkel, DVC, MLflow, SVC, FastAPI, OpenCV, etc}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
%-------------------------------------------
