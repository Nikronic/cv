...
\section{Education}
 \resumeSubHeadingListStart
   ...
   \resumeSubheadingF
     ...
     \resumeItemListStart
        \resumeItem{\textbf{Final Project:} Descreebubg and Rescreening of Halftone Images via Data-Driven Deep Learning Methods}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      {Full-time Data Engineering and Data Science Specialist}{Karaj, Iran}
       {Specializing in Advanced AI Solutions for Business Optimization}
      {April 2022 - December 2023}{\href{https://nahalgasht.com/}{Nahal Gasht}}
     
      % {I describe what I did for solving a problem at a company, and you should transform it into something suitable for a CV. Here is the description:
      ...
      \resumeItemListStart
        ...
        \resumeItem{Impact: Decreased personnel error margin by 10\%, \textbf{mitigating potential losses equivalent to 3.5 times the annual salary.} Also, \textbf{awarded for dedication and leadership}, leading to two promotions and a 70\% salary increase within one year. Moreover, \textbf{I established myself as the primary resource for onboarding and training} new team members, receiving praise for my ability to simplify fundamental concepts.}
        % \resumeItem{Impact: \textbf{Awarded for dedication and leadership}, leading to two promotions and a 70\% salary increase within one year.}
        \resumeItem{Developed a comprehensive screening process automation from customer communication to application prioritization, filtering calls based on the complexity of inquiries, reducing manual workload by 40\%.}
        % \resumeItem{Orchestrated the integration of third-party API services and SDKs when local solutions were deemed infeasible.}
        \resumeItem{Oversaw the development of a proprietary data extraction and preprocessing pipeline, resulting in a 35\% reduction in poor-quality and unlabeled data.}
        \resumeItem{Deployed a machine learning model (XGBoost) coupled with Explainable AI techniques to prioritize applications and provide transparent reasoning for each decision.}
...
\section{Research Interests}
  \resumeSubHeadingListStart
    ...
    \vspace{-5pt}
    \resumeItem{Computational Health and Medicine}
  \resumeSubHeadingListEnd
%-------------------------------------------
