  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textbf{Interdisciplinary Work}: Successfully navigated and \textbf{mastered uncharted domains} beyond my primary field.}
        \resumeItem{Experiment Management: Managed \textbf{large-scale experiments} by developing customized software solution to \textbf{track and report results}, particularly enabling \textbf{easy follow-up near deadline}.}
        \resumeItem{Group Collaboration: \textbf{Shared AI expertise} with group members, focusing on PyTorch model implementation and \textbf{optimizing workflows with Slurm clusters}.}
